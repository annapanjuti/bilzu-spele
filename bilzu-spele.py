...
btn0=Button(width=15,height=5) #sāk no 0, jo sasaistās ar saraksta elementu indeksāciju
btn1=Button(width=15,height=5)
btn2=Button(width=15,height=5)
btn3=Button(width=15,height=5)
btn4=Button(width=15,height=5)
btn5=Button(width=15,height=5)
btn6=Button(width=15,height=5)
btn7=Button(width=15,height=5)
btn8=Button(width=15,height=5)
btn9=Button(width=15,height=5)
